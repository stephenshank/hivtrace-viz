webpackJsonp(
  ...
  [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _hivtrace_cluster_graph_summary = __webpack_require__(53);

      var _histogram = __webpack_require__(54);
      ...
      module.exports.graphSummary =
        _hivtrace_cluster_graph_summary.hivtrace_cluster_graph_summary;
    ...
    /***/ function(module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function($, jQuery) {
        ...
        var hivtrace_cluster_depthwise_traversal = function hivtrace_cluster_depthwise_traversal(
          nodes,
          edges,
          edge_filter,
          save_edges,
        ...
        var hivtrace_cluster_network_graph = function hivtrace_cluster_network_graph(
          json,
          network_container,
          ...
          self.today =
            options && options["today"] ? options["today"] : new Date();
          ...
          if (self._is_CDC_) {
            ...
            self.cluster_time_scale =
              self.cluster_time_scale || _networkCDCDateField;
          }
          ...
          self.filter_if_added = function(cluster) {
            return (
              self.cluster_attributes[cluster.cluster_id].type != "existing"
            );
          };

          self.filter_time_period = function(cluster) {
            return _.some(self.nodes_by_cluster[cluster.cluster_id], function(
              n
            ) {
              return (
          ...
          if (self.cluster_attributes) {
            ...
            if (
              ...
              self.cluster_filtering_functions["recent"] =
          ...
          self.recent_rapid_definition = function(network, date) {
            ...
            var subcluster_enum = [
              ...
              "Not a member of subcluster (as of " +
                _defaultDateViewFormat(date) +
                ")", // 5
              "Not in a subcluster"
            ];
            ...
            binned_vl_recent_value: {
              ...
              color_scale: function color_scale() {
                return d3.scale
                  ...
                  .range(
                    _.union(_networkSequentialColor[3], [_networkMissingColor])
                  );
              },
          ...
          if (self.cluster_attributes) {
            self._networkPredefinedAttributeTransforms["_newly_added"] = {
              ...
              color_scale: function color_scale() {
                return d3.scale
                  .ordinal()
                  .domain(["No", "Yes", _networkMissing])
                  .range(["#3c368e", "#fcb71e", "gray"]);
              }
            };
          }
          ...
          /*------------ Network layout code ---------------*/
          var handle_cluster_click = function handle_cluster_click(
            cluster,
            release
          ) {
          ...
          self._get_node_country = function(node) {
            var countryCodeAlpha2 = self.attribute_node_value_by_id(
              node,
              "country"
            );
            if (countryCodeAlpha2 == _networkMissing) {
              countryCodeAlpha2 = self.attribute_node_value_by_id(
                node,
                "Country"
              );
            }
            ...
            if (options && "showing_on_map" in options) {
              ...
              _.each(self.nodes, function(node) {
                ...
                var countryCodeNumeric =
                  self.countryCentersObject[countryCodeAlpha2]
                    .countryCodeNumeric;
            ...
            var event_handler = function event_handler(network, e) {
              ...
              if (!network.network_cluster_dynamics) {
                network.network_cluster_dynamics = network.network_svg
                  ...
                  .attr(
                    "transform",
                    "translate (" + network.width * 0.45 + ",0)"
                  );
          ...
          self.open_exclusive_tab_view_aux = function(
            ...
            if (option_extras.type == "subcluster") {
              new_tab_content
                ...
                .addClass(
                  "subcluster-" + option_extras.cluster_id.replace(".", "_")
                );
            }
            ...
            var cluster_options = {
              ...
              extra_menu:
                options && "extra_menu" in options
                  ? options["extra_menu"]
                  : null,
              "edge-styler":
                options && "edge-styler" in options
                  ? options["edge-styler"]
                  : null,
              "no-subclusters": true,
            ...
            if (self.colorizer["opacity_id"]) {
              cluster_view.handle_attribute_opacity(
	    ...
	    self.update(false);*/
          ...
          self.view_subcluster = function(
                ...
                function(network, item) {
                  ...
                  var date = enclosure
                    ...
                    .on("input", function(e) {
                      ...
                      var set_date = _defaultDateViewFormatSlider.parse(
                        this.value
                      );
                      if (this.value) {
            ...
            if ("extra_menu" in options) {
              options["extra_menu"]["items"] = options["extra_menu"][
                "items"
	     ...
	     item.on("click", function(e) {
            ...
            try {
              ...
              _.each(split_clusters, function(cluster_nodes, cluster_index) {
                ...
                subclusters = _.map(subclusters, function(c, i) {
                  var label =
                    self.clusters[array_index].cluster_id + "-" + (i + 1);
	            ...
	            */
                ...
                _.each(subclusters, function(sub) {
                  ...
                  var subcluster_json = _extract_single_cluster(
                    _.filter(
                      sub.children,
                      _.partial(filter_by_date, cutoff_long)
                    ),
                    null,
                    true,
                    cluster_nodes
                  ...
                  self.clusters[array_index].priority_score =
                    sub.priority_score;
                });
              });
            } catch (err) {
                  ...
                  if (neighborhood_size > 500) {
                    ...
                    for (n1 = 0; n1 < neighborhood_size; n1 += 1) {
                      for (n2 = n1 + 1; n2 < neighborhood_size; n2 += 1) {
                        if (
                          self.nodes[neighborhood[n1]].neighbors.has(
                            neighborhood[n2]
                          )
                        ) {
                          counter++;
                    ...
                    member_nodes.forEach(function(node) {
                      ...
                      for (n1 = 0; n1 < my_neighbors.length; n1 += 1) {
                        for (n2 = n1 + 1; n2 < my_neighbors.length; n2 += 1) {
                          triads += 1;
                          if (
                            self.nodes[my_neighbors[n1]].neighbors.has(
                              my_neighbors[n2]
                            )
                          ) {
                            triangles += 1;
          ...
          function initial_json_load() {
                ...
                result.push(
                  _.map(column_names, function(c) {
                    if (c.raw_attribute_key == _networkNodeIDField) {
                      if (
                        n.attributes &&
                        n.attributes.indexOf("new_node") >= 0
                      ) {
                        return n.id + "[+]";
                      }
                      return n.id;
                    ...
                    format: function format() {
                      return {
                        ...
                        number_of_genotypes_in_past_2_months:
                          "Number of genotypes in past 2 months",
                        scaled_number_of_genotypes_in_past_2_months:
                          "Scaled Number of Genotypes in past 2 months",
                        group_by_attribute: "Group by attribute",
                        group_by_id: "Group by ID",
                        listing_nodes_in_cluster: "Listing Nodes in Cluster",
                        missing: "Missing"
                      }["cluster_id"];
                    }
                  },
            ...
            if (button_bar_ui) {
              ...
              var node_label_handler = function node_label_handler(do_show) {
                ...
                button_group
                  ...
                  .attr(
                    "title",
                    {
                      ...
                      hide_labels_for_all: "Hide labels for all nodes",
                      highlight_unsupported_edges:
                        "Highlight unsupported edges",
                      show_epidemiological_growth:
                        "Show epidemiological growth",
                      only_recent_clusters:
                        "Show only clusters changed in the recent 12 months",
                      show_removed_edges: "Show removed edges"
                    }["expand_spacing"]
                ...
                .on(
                  ...
                  _.throttle(function(e) {
                    if ("size" in self.cluster_filtering_functions) {
                      ...
                      self.cluster_filtering_functions["size"] =
                        self.filter_by_size;
                    }
            ...
            try {
              if (options && options["extra_menu"]) {
                var extra_ui_container = d3.select(
                  self.get_ui_element_selector_by_role(
                    "extra_operations_container"
                  )
                );

                d3.select(
                  self.get_ui_element_selector_by_role(
                    "extra_operations_enclosure"
                  )
                )
                  .selectAll("button")
            ...
            self._aux_populate_category_menus = function() {
              if (button_bar_ui) {
                ...
                var valid_scales = _.filter(
                    ...
                    if (d.type == "Number") {
                      ...
                      if (d.type == "Date") {
                        var values = _.filter(
                          _.map(graph_data.Nodes, function(nd) {
                            try {
                              var a_date = self.attribute_node_value_by_id(
                                nd,
                                k
                              );
                  ...
                  function(d) {
                    return (
                      (d.type == "Number" || d.type == "Date") && !d["_hidden_"]
                    );
                  }
                );
	      ...
	      */
              ...
              if ("attribute_map" in attributes) {
                ...
                if ("map" in attribute_map && attribute_map["map"].length > 0) {
                  ...
                  graph_data.Nodes.forEach(function(n) {
                    n[_networkGraphAttrbuteID] = n.id.split(
                    ...
                    n[_networkGraphAttrbuteID].forEach(function(v, i) {
                      if (i < graph_data[_networkGraphAttrbuteID].length) {
                        if (
                          !(
                            v in
                            graph_data[_networkGraphAttrbuteID][i]["values"]
                          )
                        ) {
            ...
            if (self.cluster_sizes.length > max_points_to_render) {
              ...
              for (
                var k = 0;
                k < sorted_array.length - max_points_to_render;
                k++
              ) {
          ...
          function format_a_cell(data, index, item) {
            ...
            if ("callback" in data) {
              ...
              var repr =
                "format" in data ? data.format(current_value) : current_value;
            ...
            if (payload[4]) {
              if (payload[4]["type"] == "new") {
                ...
                if (payload[4]["type"] == "extended") {
                  labels.push(["+" + payload[4]["delta"] + " nodes", 2]);
                } else {
                  ...
                  if (d[1] == 2) {
                    ...
                    self
                      .open_exclusive_tab_view(
                        ...
                        null,
                        function(cluster_id) {
                          return "Cluster " + cluster_id + " [changes view]";
                        },
                        self._social_view_options(
                          link_class,
                          shown_types,
                          function(e) {
	     ...
	     */
          ...
          self.draw_extended_node_table = function(node_list) {
            if (self.node_table) {
              ...
              self.displayed_node_subset = _.map(
                self.displayed_node_subset,
                function(n, i) {
                  if (_.isString(n)) {
          ...
          self.draw_cluster_table = function(extra_columns, element, options) {
            var skip_clusters =
              options && options["no-clusters"] ? true : false;
            var skip_subclusters =
              options && options["subclusters"] ? false : true;
                  ...
                  value:
                    {
                      ...
                      sequences_used_to_make_links:
                        "Sequences used to make links",
                      clusters: "Clusters",
                      nodes: "Nodes",
                      edges: "Edges",
                      ...
                      genetic_distances_among_linked_nodes:
                        "Genetic distances among linked nodes",
              ...
              _.each(self.clusters, function(cluster) {
                var make_row = function make_row(d, is_subcluster) {
                  var this_row = [
                    ...
                    {
                      value: function value() {
                        var actual_cluster = is_subcluster
                          ? d.parent_cluster
                          : d;
                  ...
                  if (self._is_seguro) {
                    this_row.push({
                      ...
                      format: function format(d) {
                        return _.filter(d.children, function(child) {
                          return (
                            d3.time.months(
                    ...
                    this_row.push({
                      value: d,
                      format: function format(d) {
                        var recent = _.filter(d.children, function(child) {
                          return (
                            d3.time.months(
                              child.patient_attributes["sample_dt"],
                              new Date()
          ...
          function update_network_string(node_count, edge_count) {
            if (network_status_string) {
              var clusters_shown = _.filter(self.clusters, function(c) {
                ...
                clusters_removed =
                  self.cluster_sizes.length - self.clusters.length,
                nodes_removed =
          ...
          function draw_a_cluster(container, the_cluster) {
            ...
            draw_from = draw_from.map(function(d) {
              ...
              var v = {
                ...
                endAngle:
                  ((running_totals[index] + d[1]) / sums[index]) * 2 * Math.PI,
                name: d[0],
                rim: index > 0
              };
          ...
          function check_for_predefined_shapes(cat_id) {
            ...
            if (cat_id in _networkPresetShapeSchemes) {
              var domain = _.range(
                0,
                graph_data[_networkGraphAttrbuteID][cat_id]["value_range"]
                  .length
              );
          ...
          self.handle_shape_categorical = function(cat_id) {
            ...
            ["shapes"].forEach(function(lbl) {
              ...
              d3.select(
                self.get_ui_element_selector_by_role(lbl + "_label")
              ).html(
                {
                  color: "Color",
                  shape: "Shape",
          ...
          self.draw_attribute_labels = function() {
            ...
            var determine_label_format_cont = function determine_label_format_cont(
              field_data
            ) {
          ...
          function compute_cluster_gradient(cluster, cat_id) {
            if (cat_id) {
              var id =
                self.dom_prefix + "-cluster-gradient-" + self.gradient_id++;
          ...
          self.handle_attribute_continuous = function(cat_id) {
            ...
            [["attributes", false], ["attributes_cat", true]].forEach(function(
              lbl
            ) {
          ...
          self.handle_attribute_categorical = function(cat_id, skip_update) {
            ...
            if (cat_id) {
              if (cat_id in _networkPresetColorSchemes) {
                var domain = [],
                  range = [];
                _.each(_networkPresetColorSchemes[cat_id], function(
                  value,
                  key
                ) {
                  domain.push(key);
                ...
                if (
                  graph_data[_networkGraphAttrbuteID][cat_id]["color_scale"]
                ) {
                  ...
                  var extended_range = _.clone(
                    self.colorizer["category"].range()
                  );
              ...
              self.colorizer[
                "category_pairwise"
              ] = attribute_pairwise_distribution(
                cat_id,
                graph_data[_networkGraphAttrbuteID][cat_id].dimension,
                self.colorizer["category_map"]
              );
	        ...
	        this.append ("path");
              ...
              if (
                ...
                _.each(self.clusters, function(cluster_nodes, cluster_index) {
                  /** extract subclusters; all nodes at given threshold */
                  /** Sub-Cluster: all nodes connected at 0.005 subs/site; there can be multiple sub-clusters per cluster */
                  var subclusters = _.groupBy(cluster_nodes.children, function(
                    n
                  ) {
                    return n.subcluster_id;
                  });
                  subclusters = _.values(
                    _.reject(subclusters, function(v, k) {
                      return k == "undefined";
                    })
                  );
                  ...
                  var stats =
                    self.json.subcluster_summary_stats[
                      cluster_nodes.cluster_id
                    ];
                  cluster_nodes.recent_nodes = _.map(_.values(stats), function(
                    d
                  ) {
          ...
          function node_color(d) {
            ...
            if (self.colorizer["category_id"]) {
              var v = self.attribute_node_value_by_id(
                d,
                self.colorizer["category_id"]
              );
              if (self.colorizer["continuous"]) {
              ...
              function(key) {
                if (key) {
                  if (key in graph_data[_networkGraphAttrbuteID]) {
                    ...
                    if (
                      graph_data[_networkGraphAttrbuteID][key]["type"] == "Date"
                    ) {
                      try {
          ...
          function collapse_cluster(x, keep_in_q) {
            ...
            x.collapsed = true;
            currently_displayed_objects -=
              self.cluster_sizes[x.cluster_id - 1] - 1;
            if (!keep_in_q) {
          ...
          function expand_cluster(x, copy_coord) {
            ...
            if (copy_coord) {
              ...
              x.children.forEach(function(n) {
                n.x =
                  self.width * 0.25 + (Math.random() - 0.5) * x.children.length;
                n.y =
                  0.25 * self.height +
                  (Math.random() - 0.5) * x.children.length;
              });
            }
          }

          function render_binned_table(id, the_map, matrix) {
            var the_table = d3.select(
              self.get_ui_element_selector_by_role(id, true)
            );
            if (the_table.empty()) {
              return;
            }
          ...
          function attribute_pairwise_distribution(
            ...
            _.each(scan_from, function(edge) {
              ...
              the_matrix[
                the_map(
                  self.attribute_node_value_by_id(self.nodes[edge.source], id)
                )
              ][
                the_map(
                  self.attribute_node_value_by_id(self.nodes[edge.target], id)
                )
              ] += 1;
            });
          ...
          self.expand_cluster_handler = function(d, do_update, move_out) {
            if (d.collapsed) {
              ...
              if (new_nodes > max_points_to_render) {
                self.warning_string =
                  "This cluster is too large to be displayed";
              } else {
                var leftover =
                  new_nodes +
                  currently_displayed_objects -
                ...
                if (leftover > 0) {
                  ...
                  for (; k < open_cluster_queue.length && leftover > 0; k++) {
                    var cluster =
                      self.clusters[
                        self.cluster_mapping[open_cluster_queue[k]]
                      ];
	     ...
	     */
            ...
            try {
              ...
              var handle_node_attributes = function handle_node_attributes(
                target,
                n
              ) {
              ...
              if (nodes_and_attributes && nodes_and_attributes.length) {
                ...
                _.each(nodes_and_attributes, function(n) {
                  if (n[index_id] in existing_network_nodes) {
                    handle_node_attributes(
                      existing_network_nodes[n[index_id]],
                      n
                    );
                    existing_nodes++;
                  } else {
              ...
              if (edges_and_attributes && edges_and_attributes.length) {
                ...
                if (auto_inject) {
                  existing_nodes = _.size(
                    _.filter(existing_network_nodes, function(e) {
                      return e;
                    })
                  );
                }
                ...
                self.update_clusters_with_injected_nodes(
                  null,
                  null,
                  annotation
                );
	        ...
	        */
                ...
                var _social_view_handler = function _social_view_handler(
                  id,
                  node_filter,
                  labeled_links,
                  shown_types,
                ...
                var _injected_column_subcluster_button_handler = function _injected_column_subcluster_button_handler(
                  payload,
                  edge_filter,
                  title,
                  e
                          ...
                          this_cell
                            ...
                            .on(
                              ...
                              _.partial(
                                ...
                                function(edge) {
                                  return (
                                    self.json.Nodes[edge.target].id in
                                      node_ids ||
                ...
                var injected_column = [
                  {
                    description: {
                      ...
                      help:
                        "Nodes added and clusters merged through " + annotation
                    },
                    generator: function generator(cluster) {
                      return {
                        value: [
                        ...
                        callback: function callback(element, payload) {
                          var this_cell = d3.select(element);
                          this_cell.text(
                            +payload[0] + " " + annotation + " nodes. "
                          );
                          var other_clusters = [];
                          if (payload[1]) {
                            other_clusters = _.without(
                              _.keys(payload[1]),
                              payload[2]
                            );
                                ...
                                var direct_links_only = hivtrace_cluster_depthwise_traversal(
                                  ...
                                  function(edge) {
                                    return (
                                      self.json.Nodes[edge.target].id in
                                        node_ids ||
                                      self.json.Nodes[edge.source].id in
                                        node_ids
                                    );
                                  },
                                  false,
          ...
          function toggle_tooltip(element, turn_on, title, tag, container) {
            ...
            if (turn_on && !element.tooltip) {
              ...
              _.delay(
                _.bind(element.tooltip.tooltip, element.tooltip),
                500,
                "show"
              );
            } else {
          ...
          var network_layout = d3.layout
            ...
            .charge(function(d) {
              ...
              if (d.cluster_id)
                return (
                  self.charge_correction *
                  (-15 - 5 * Math.pow(d.children.length, 0.4))
                );
	  ...
	  */
          ...
          if (options) {
            ...
            if (self.showing_diff) {
              if (self._is_CDC_) {
                self.handle_attribute_categorical(
                  self._is_CDC_ ? "recent_rapid" : "_newly_added"
                );
              }
            } else {
            }
        ...
        var hivtrace_cluster_graph_summary = function hivtrace_cluster_graph_summary(
          graph,
          tag
        ) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      _.each(_.range(3, 20), function(d) {
        ...
        hivtrace_generate_svg_polygon_lookup[d] = _.map(_.range(1, d), function(
          i
        ) {
      ...
      function hivtrace_plot_cluster_dynamics(
        ...
        var skip_cumulative =
          (options && options["skip_cumulative"]) || do_barchart;
        ...
        var svg = container
          ...
          .attr(
            "transform",
            "translate(" + options.left + "," + options.top + ")"
          );
    ...
    /***/ function(module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function(d3, $) {
        ...
        var datamonkey_export_csv_button = function datamonkey_export_csv_button(
          data
        ) {
        ...
        var datamonkey_save_image = function datamonkey_save_image(
          type,
          container
        ) {
          var prefix = {
        ...
        /* WEBPACK VAR INJECTION */
      }.call(exports, __webpack_require__(39), __webpack_require__(2)));
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function hivtrace_render_scatterplot(points, w, h, id, labels, dates) {
        ...
        var xAxis = d3.svg
          ...
          .orient("bottom")
          .tickFormat(
            dates ? _defaultDateViewFormatShort : _defaultFloatFormat
          );
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      Object.keys(topojsonClient).forEach(function(key) {
        exports[key] = topojsonClient[key];
      });
      Object.keys(topojsonServer).forEach(function(key) {
        exports[key] = topojsonServer[key];
      });
      Object.keys(topojsonSimplify).forEach(function(key) {
        exports[key] = topojsonSimplify[key];
      });
          ...
          polygons.forEach(function(polygon) {
            if (!polygon._) {
              ...
              while ((polygon = neighbors.pop())) {
                ...
                polygon.forEach(function(ring) {
                  ring.forEach(function(arc) {
                    polygonsByArc[arc < 0 ? ~arc : arc].forEach(function(
                      polygon
                    ) {
                      if (!polygon._) {
                        polygon._ = 1;
      ...
      (function(global, factory) {
        ...
        var bounds = function(objects) {
          ...
          function boundGeometry(geometry) {
            if (
              geometry != null &&
              boundGeometryType.hasOwnProperty(geometry.type)
            )
        ...
        var dedup = function(topology) {
          ...
          function dedupLine(arc) {
            ...
            if (
              (startArcs = arcsByEnd.get((startPoint = coordinates[arc[0]])))
            ) {
        ...
        var topology = function(objects, quantization) {
          ...
          function indexGeometry(geometry$$1) {
            if (
              geometry$$1 &&
              indexGeometryType.hasOwnProperty(geometry$$1.type)
            )
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      (function(global, factory) {
        true
          ? factory(exports, __webpack_require__(52))
          : typeof define === "function" && define.amd
          ? define(["exports", "topojson-client"], factory)
        ...
        var filterWeight = function(topology, minWeight, weight) {
          ...
          return function(ring, interior) {
            return (
              weight(
                topojsonClient.feature(topology, {
                  type: "Polygon",
                  arcs: [ring]
        ...
        var presimplify = function(topology, weight) {
          var point = topology.transform
              ? topojsonClient.transform(topology.transform)
              : copy,
            heap = newHeap();
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function hivtrace_histogram_distances(
        graph,
        histogram_tag,
        histogram_label
      ) {
